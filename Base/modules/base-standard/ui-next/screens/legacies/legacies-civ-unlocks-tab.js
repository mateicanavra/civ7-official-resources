...
import { useContext, createSignal, createMemo, onMount, onCleanup, createEffect, on, createComponent, Show, For, createRenderEffect, mergeProps, untrack } from '../../../../core/vendor/solid-js/dist/solid.js';
...
const LegaciesUnlocksTabComponent = () => {
  ...
  const filteredCivs = createMemo(() => {
    return unlocksModel.civInfo.filter((civ) => {
      const matchAge = civ.apexAge == selectedAgeFilter().ageType || !selectedAgeFilter().ageType;
      const matchAttribute = attributeFilter() == "LOC_LEGACIES_FILTER_ALL_ATTRIBUTES" || civ.traits.some((t) => t == attributeFilter());
      const matchText = !enableTextFilter() || civ.fulltext.includes(normalizedText());
                                                ...
                                                return createComponent(Tab.Trigger, {
                                                  ...
                                                  get children() {
                                                    return createComponent(CivCard, mergeProps({
                                                      ...
                                                      get isSelected() {
                                                        return untrack(() => {
                                                          return civ.civID == civSelectModel.selectedCiv().civID;
                                                        });
                                                      },
                            ...
                            insert(_el$2, createComponent(AudioContextProvider, {
                              ...
                              get children() {
                                return createComponent(Show, {
                                  ...
                                  get children() {
                                    return [createComponent(CivDetailsBase, {}), createComponent(Activatable, {

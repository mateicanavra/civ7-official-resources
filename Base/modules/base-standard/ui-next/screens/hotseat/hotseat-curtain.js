...
import { createMemo, createSignal, onMount, createComponent, Show, createRenderEffect } from '../../../../core/vendor/solid-js/dist/solid.js';
  ...
  return createComponent(Show, {
    ...
    get children() {
      ...
      createRenderEffect((_p$) => {
        var _v$ = playerColor(), _v$2 = playerColor(), _v$3 = `url(${civIcon()})`;
...
defineLegacyComponent("hotseat-curtain", {
  initializeImmediately: true
}, (attrs, el) => {
  return createComponent(HotseatCurtain, {
    attrs,
    el
  });
});

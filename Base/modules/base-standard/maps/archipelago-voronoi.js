...
import { VoronoiArchipelago } from '../scripts/voronoi_maps/archipelago.js';

console.log("Generating using script archipelago-voronoi.ts");
...
async function generateMap() {
  ...
  const voronoiScope = new profileScope("Archipelago Voronoi Generation");
  ...
  const voronoiMap = new VoronoiArchipelago();
...
//# sourceMappingURL=archipelago-voronoi.js.map

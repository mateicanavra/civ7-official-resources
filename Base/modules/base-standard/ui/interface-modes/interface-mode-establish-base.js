...
class EstablishBaseInterfaceMode extends ChoosePlotInterfaceMode {
  ...
  plotAndUnitSelectionHandler = (plot, previousPlot) => {
    return WorldInput.handleChoosePlotWithUnits(plot, previousPlot) ? false : this.selectPlot(plot, previousPlot);
  };
  initialize() {
    const context = this.Context;
    const args = {};
    this.plotSelectionHandler = this.plotAndUnitSelectionHandler;
...
//# sourceMappingURL=interface-mode-establish-base.js.map

...
class AutomationTestPlayGameFixedViewMR extends AutomationBasePlayGameXR {
  automationTestPlayGameFixedViewMRListener = (command, ...args) => {
...
const automationTestPlayGameFixedViewMRHandler = new AutomationTestPlayGameFixedViewMR();
automationTestPlayGameFixedViewMRHandler.register();
Automation.setScriptHasLoaded("automation-test-play-game-fixed-view-mr");
//# sourceMappingURL=automation-test-play-game-fixed-view-mr.js.map

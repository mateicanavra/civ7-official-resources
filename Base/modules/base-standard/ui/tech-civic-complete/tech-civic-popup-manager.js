  ...
  onTechNodeCompleted(data) {
    if (ContextManager.shouldShowPopup(data.player)) {
      ...
      if (node.ProgressionTreeNodeType == "NODE_TECH_AQ_AGRICULTURE") {
        if (Configuration.getUser().tutorialLevel == TutorialLevel.TutorialOn && !Online.Metaprogression.isPlayingActiveEvent()) {
          return;
        }
      }
...
export { ProgressionTreeTypes, TechCivicPopupVisibility, TechCivicPopupManager as default };
//# sourceMappingURL=tech-civic-popup-manager.js.map

...
import { BANNER_INVALID_LOCATION } from './banner-support.js';
...
class CityBannerManager extends Component {
  ...
  onAttach() {
    ...
    engine.on("ResourceAssigned", this.onResourceChanged, this);
    engine.on("ResourceUnassigned", this.onResourceChanged, this);
  ...
  onDetach() {
    ...
    engine.off("CapitalCityChanged", this.capitalCityChangedListener);
    ...
    engine.off("CityProductionQueueChanged", this.cityProductionQueueChangedListener);
    ...
    engine.off("ResourceAssigned", this.onResourceChanged, this);
    engine.off("ResourceUnassigned", this.onResourceChanged, this);
  ...
  onResourceChanged(data) {
    ...
    if (!cityBanner) {
      console.error(
        "A resource was changed in a city but no associated banner was found. cid: ",
        ComponentID.toLogString(data.targetCity)
      );
      return;
    }
    const resourceDef = GameInfo.Resources.lookup(data.resourceType);
    if (resourceDef != null) {
      const resourceYieldsTags = this.indexResourceTypes();
      const yields = resourceYieldsTags.get(resourceDef.ResourceType);
      if (yields) {
        const hasHappiness = yields.has("YIELD_HAPPINESS");
        if (hasHappiness) {
  ...
  onCityPopulationChanged(data) {
    ...
    cityBanner.fullUpdate("onCityPopulationChanged");
  }
  ...
  onCityProductionChanged(data) {
    ...
    cityBanner.fullUpdate("onCityProductionChanged");
  }
  onCityProductionQueueChanged(data) {
    ...
    cityBanner.fullUpdate("onCityProductionQueueChanged");
  }
  onCityYieldChanged(data) {
    ...
    cityBanner.fullUpdate("onCityYieldChanged");
  }
  onCityProductionUpdated(data) {
    ...
    cityBanner.fullUpdate("onCityProductionUpdated");
  }
  onCityYieldGranted(data) {
    if (data.yield == YieldTypes.YIELD_FOOD || data.yield == YieldTypes.YIELD_PRODUCTION) {
      ...
      cityBanner.fullUpdate("onCityYieldGranted");
    }
  }
  onCityFoodQueueUpdated(data) {
    ...
    cityBanner.fullUpdate("onCityFoodQueueUpdated");
  }
  /**
   * Hotseat
   * @param _data unused
...
//# sourceMappingURL=city-banner-manager.js.map

...
const ScrollAreaComponent = (props) => {
  ...
  const scrollByPixels = (pixels) => {
    const height = Math.max(1, scrollWrapper.scrollHeight - scrollWrapper.clientHeight);
    scrollByPercent(pixels / height * 100);
  };

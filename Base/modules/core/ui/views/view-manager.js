...
class ViewManagerSingleton {
  ...
  get viewHasFocus() {
    ...
    return FocusManager.get().isWorldFocused() || harness != null && FocusManager.get().getFocusChildOf(harness) != null;
  }
  /**
...
export { SwitchViewResult, UISystem, ViewManager as default };

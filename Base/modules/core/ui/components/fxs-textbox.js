    ...
    if (ActionHandler.isGamepadActive) {
      switch (UI.getVirtualKeyboardType()) {
        ...
        case UIVirtualKeyboardType.Inline:
          ...
          FocusManager.get().setFocus(this.textInput);
          break;
        default:
          break;
      }
...
export { FxsTextboxValidateVirtualKeyboard, TextBoxTextChangedEvent, TextBoxTextChangedEventName, TextBoxTextEditStopEvent, TextBoxTextEditStopEventName, FxsTextbox as default };
//# sourceMappingURL=fxs-textbox.js.map

class FxsRingMeter extends Component {
  ...
  get value() {
    const attrValue = Number(this.Root.getAttribute("value") ?? 100);
    if (isNaN(attrValue)) {
      console.log(
        "fxs-ring-meter: Ring meter's attribute value set to NaN. Defaulting to 100. (Did a divide by 0 happen earlier?)"
      );
      return 100;
    }
    return attrValue;
  ...
  calculateRingFillPercentage() {
    ...
    if (isNaN(this.ringFill)) {
      console.log("fxs-ring-meter: Ring meter value is NaN, defaulting to 0.");
      this.ringFill = 0;
    }
  }
  startAnimation() {
...
export { FxsRingMeter, FxsRingMeter as default };
//# sourceMappingURL=fxs-ring-meter.js.map
